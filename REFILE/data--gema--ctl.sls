...
##  - Purpose: Clones the 'gema-ctl' repo for use w/ submodule tracking
##



## <JINJA>
{% set uri_git_upstream = salt['pillar.get']('', "https://github.com/genesis-matrix/gema-ctl.git") %}
{% set uri_git_clonedir = salt['pillar.get']('', "/var/cache/gema/ctl.git") %}
