...
# {{ salt['mysql.user_list'](connection_user=var['db_connection_user'], connection_pass=var['db_connection_password']) }}
# {{ salt['mysql.db_tables']("zabbix", connection_user=var["db_connection_user"], connection_pass=var["db_connection_password"]) }}
